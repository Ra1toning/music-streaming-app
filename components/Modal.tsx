      ...
      <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
        <Dialog.Portal>
          <Dialog.Overlay className="bg-neutral-900/90 backdrop-blur-sm fixed inset-0 z-50">
            <Dialog.Content className="fixed flex flex-col md:flex-row text-white drop-shadow-md rounded-lg border border-neutral-700 top-[50%] left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[900px] translate-x-[-50%] translate-y-[-50%] bg-neutral-800 p-0 focus:outline-none">
              {/* Left Section: Form */}
              ...
              {/* Right Section: Image */}
              <div className="relative hidden md:block w-3/5 bg-cover bg-center rounded-lg" style={{ backgroundImage: `url('/images/auth/auth.jpg')` }}>
